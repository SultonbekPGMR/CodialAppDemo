...
import com.codialstudent.codialappdemo.databinding.FragmentGroupsOpenedBinding
...
class GroupsOpened : Fragment(), RvGroupClick {
    ...
    override fun btnEditClick(group: MyGroup, position: Int) {
        ...
        val dialog: AlertDialog =
            AlertDialog.Builder(
                requireContext(),
                com.codialstudent.codialappdemo.R.style.MyMenuDialogTheme
            )
    ...
    override fun btnViewClick(group: MyGroup, position: Int) {
        findNavController().navigate(
            com.codialstudent.codialappdemo.R.id.viewGroup,
